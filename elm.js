...
module.exports = exports['default'];
},{"./clipboard-action":1,"good-listener":7,"tiny-emitter":9}],3:[function(require,module,exports){
...
Elm.Clipboard = Elm.Clipboard || {};
Elm.Clipboard.make = function (_elm) {
   "use strict";
   _elm.Clipboard = _elm.Clipboard || {};
   if (_elm.Clipboard.values) return _elm.Clipboard.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Native$Clipboard = Elm.Native.Clipboard.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var initialize = $Native$Clipboard.initialize;
   var Error = function (a) {    return {action: a};};
   var Success = F2(function (a,b) {
      return {text: a,action: b};
   });
   var Cut = {ctor: "Cut"};
   var Copy = {ctor: "Copy"};
   return _elm.Clipboard.values = {_op: _op
                                  ,initialize: initialize
                                  ,Success: Success
                                  ,Error: Error
                                  ,Copy: Copy
...
Elm.Clipboard = Elm.Clipboard || {};
Elm.Clipboard.Attributes = Elm.Clipboard.Attributes || {};
Elm.Clipboard.Attributes.make = function (_elm) {
   "use strict";
   _elm.Clipboard = _elm.Clipboard || {};
   _elm.Clipboard.Attributes = _elm.Clipboard.Attributes || {};
   if (_elm.Clipboard.Attributes.values)
   return _elm.Clipboard.Attributes.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Clipboard = Elm.Clipboard.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var decodeAction = function () {
      var toAction = function (s) {
         var _p0 = s;
         switch (_p0)
         {case "copy": return $Json$Decode.succeed($Clipboard.Copy);
            case "cut": return $Json$Decode.succeed($Clipboard.Cut);
            default: return $Json$Decode.fail(A2($Basics._op["++"],
              "Unknown clipboard action ",
              s));}
      };
      return A2($Json$Decode.andThen,$Json$Decode.string,toAction);
   }();
   var decodeError = A2($Json$Decode.object1,
   $Clipboard.Error,
   A2($Json$Decode._op[":="],"action",decodeAction));
   var decodeSuccess = A3($Json$Decode.object2,
   $Clipboard.Success,
   A2($Json$Decode._op[":="],"text",$Json$Decode.string),
   A2($Json$Decode._op[":="],"action",decodeAction));
   var onClipboardError = F2(function (address,toAction) {
      return A3($Html$Events.on,
      "clipboardError",
      decodeError,
      function (error) {
         return A2($Signal.message,address,toAction(error));
      });
   });
   var onClipboardSuccess = F2(function (address,toAction) {
      return A3($Html$Events.on,
      "clipboardSuccess",
      decodeSuccess,
      function (success) {
         return A2($Signal.message,address,toAction(success));
      });
   });
   var clipboardAction = function (action) {
      var actionName = $String.toLower($Basics.toString(action));
      return A2($Html$Attributes.attribute,
      "data-clipboard-action",
      actionName);
   };
   var clipboardTarget = function (selector) {
      return A2($Html$Attributes.attribute,
      "data-clipboard-target",
      selector);
   };
   var clipboardText = function (text) {
      return A2($Html$Attributes.attribute,
      "data-clipboard-text",
      text);
   };
   return _elm.Clipboard.Attributes.values = {_op: _op
...
Elm.Example.Target = Elm.Example.Target || {};
Elm.Example.Target.make = function (_elm) {
   "use strict";
   _elm.Example = _elm.Example || {};
   _elm.Example.Target = _elm.Example.Target || {};
   if (_elm.Example.Target.values)
   return _elm.Example.Target.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Clipboard = Elm.Clipboard.make(_elm),
   $Clipboard$Attributes = Elm.Clipboard.Attributes.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   ...
   var sampleText = "elm package install evancz/elm-http 2.0.0";
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.input,
              _U.list([$Html$Attributes.type$("text")
                      ...
                      ,$Html$Attributes.value(sampleText)]),
              _U.list([]))
              ,A2($Html.span,
              _U.list([$Html$Attributes.$class("input-group-button")]),
              _U.list([A2($Html.button,
              _U.list([$Clipboard$Attributes.clipboardTarget("#copy")
                      ,$Html$Attributes.$class("btn")]),
              _U.list([A2($Html.span,
              _U.list([$Html$Attributes.$class("octicon octicon-clippy")]),
              _U.list([]))]))]))]));
   });
   var NoOp = {ctor: "NoOp"};
   var init = function () {
      var fx = $Effects.task(A2($Task.onError,
      A2($Task.andThen,
      $Clipboard.initialize({ctor: "_Tuple0"}),
      function (_p1) {
      ...
      var model = {ctor: "_Tuple0"};
      return {ctor: "_Tuple2",_0: model,_1: fx};
   }();
   return _elm.Example.Target.values = {_op: _op
                                       ,NoOp: NoOp
...
Elm.Example = Elm.Example || {};
Elm.Example.Event = Elm.Example.Event || {};
Elm.Example.Event.make = function (_elm) {
   "use strict";
   _elm.Example = _elm.Example || {};
   _elm.Example.Event = _elm.Example.Event || {};
   if (_elm.Example.Event.values) return _elm.Example.Event.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Clipboard = Elm.Clipboard.make(_elm),
   $Clipboard$Attributes = Elm.Clipboard.Attributes.make(_elm),
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "ClipboardSuccess": return {ctor: "_Tuple2"
                                       ,_0: _U.update(model,{copied: true})
                                       ,_1: $Effects.none};
         case "ClearCopied": return {ctor: "_Tuple2"
                                    ,_0: _U.update(model,{copied: false})
                                    ,_1: $Effects.none};
         default: return {ctor: "_Tuple2",_0: model,_1: $Effects.none};}
   });
   var sampleText = "elm package install evancz/elm-http 2.0.0";
   var ClearCopied = {ctor: "ClearCopied"};
   var ClipboardSuccess = function (a) {
      return {ctor: "ClipboardSuccess",_0: a};
   };
   var view = F2(function (address,model) {
      var tooltipAttrs = _U.list([$Html$Attributes.$class("btn tooltipped tooltipped-s")
                                 ,A2($Html$Attributes.attribute,"aria-label","Copied!")]);
      var buttonWithTooltip = F2(function (attrs,content) {
         return A2($Html.button,
         A2($Basics._op["++"],attrs,tooltipAttrs),
         content);
      });
      return A2($Html.span,
      _U.list([$Html$Attributes.$class("input-group")]),
      _U.list([A2($Html.input,
              ...
              ,A2($Html.span,
              _U.list([$Html$Attributes.$class("input-group-button")]),
              _U.list([A2(model.copied ? buttonWithTooltip : $Html.button,
              _U.list([$Clipboard$Attributes.clipboardText(sampleText)
                      ,A2($Clipboard$Attributes.onClipboardSuccess,
                      address,
                      ClipboardSuccess)
                      ,A2($Html$Events.onMouseLeave,address,ClearCopied)
                      ,$Html$Attributes.$class("btn")]),
              _U.list([A2($Html.span,
              _U.list([$Html$Attributes.$class("octicon octicon-clippy")]),
              _U.list([]))]))]))]));
   ...
   var init = function () {
      ...
      var model = {copied: false};
      return {ctor: "_Tuple2",_0: model,_1: fx};
   }();
   var Model = function (a) {    return {copied: a};};
   return _elm.Example.Event.values = {_op: _op
                                      ,Model: Model
                                      ,NoOp: NoOp
                                      ,ClipboardSuccess: ClipboardSuccess
                                      ,ClearCopied: ClearCopied
                                      ,sampleText: sampleText
                                      ,init: init
                                      ,update: update
                                      ,view: view
...
Elm.Example = Elm.Example || {};
Elm.Example.Cut = Elm.Example.Cut || {};
Elm.Example.Cut.make = function (_elm) {
   "use strict";
   _elm.Example = _elm.Example || {};
   _elm.Example.Cut = _elm.Example.Cut || {};
   if (_elm.Example.Cut.values) return _elm.Example.Cut.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Clipboard = Elm.Clipboard.make(_elm),
   $Clipboard$Attributes = Elm.Clipboard.Attributes.make(_elm),
   ...
   var initialText = "elm package install evancz/elm-http 2.0.0";
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "ClipboardSuccess": return {ctor: "_Tuple2"
                                       ,_0: _U.update(model,{text: ""})
                                       ,_1: $Effects.none};
         case "Reset": return {ctor: "_Tuple2"
                              ,_0: _U.update(model,{text: initialText})
                              ,_1: $Effects.none};
         default: return {ctor: "_Tuple2",_0: model,_1: $Effects.none};}
   });
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.input,
              _U.list([$Html$Attributes.type$("text")
                      ,$Html$Attributes.id("cut")
                      ,$Html$Attributes.value(model.text)
                      ,$Html$Attributes.$class("input-block")]),
              _U.list([]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("text-right")]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("btn-group")]),
              _U.list([A2($Html.button,
                      _U.list([$Clipboard$Attributes.clipboardTarget("#cut")
                              ,$Clipboard$Attributes.clipboardAction($Clipboard.Cut)
                              ,A2($Clipboard$Attributes.onClipboardSuccess,
                              address,
                              ClipboardSuccess)
                              ,$Html$Attributes.$class("btn")]),
                      _U.list([$Html.text("Cut")]))
                      ,A2($Html.button,
   ...
   var init = function () {
      ...
      var model = {text: initialText};
      return {ctor: "_Tuple2",_0: model,_1: fx};
   }();
   var Model = function (a) {    return {text: a};};
   return _elm.Example.Cut.values = {_op: _op
                                    ,Model: Model
                                    ,NoOp: NoOp
                                    ,ClipboardSuccess: ClipboardSuccess
                                    ,Reset: Reset
...
Elm.Example = Elm.Example || {};
Elm.Example.Text = Elm.Example.Text || {};
Elm.Example.Text.make = function (_elm) {
   "use strict";
   _elm.Example = _elm.Example || {};
   _elm.Example.Text = _elm.Example.Text || {};
   if (_elm.Example.Text.values) return _elm.Example.Text.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Clipboard = Elm.Clipboard.make(_elm),
   $Clipboard$Attributes = Elm.Clipboard.Attributes.make(_elm),
   ...
   return _elm.Example.Text.values = {_op: _op
                                     ,NoOp: NoOp
                                     ,sampleText: sampleText
                                     ,init: init
                                     ,update: update
...
Elm.Example.make = function (_elm) {
   ...
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Example$Cut = Elm.Example.Cut.make(_elm),
   $Example$Event = Elm.Example.Event.make(_elm),
   $Example$Target = Elm.Example.Target.make(_elm),
   $Example$Text = Elm.Example.Text.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var linkToSample = function (file) {
      var url = A2($Basics._op["++"],
      "https://github.com/jdudek/elm-clipboard/blob/master/examples/",
      file);
      return A2($Html.a,
      _U.list([$Html$Attributes.href(url)]),
      _U.list([$Html.text("Full example")]));
   };
   var codeSample = function (string) {
      return A2($Html.pre,
      _U.list([]),
      _U.list([A2($Html.code,
      _U.list([$Html$Attributes.$class("elm")]),
      _U.list([$Html.text(string)]))]));
   };
   var lead = A2($Html.p,
   _U.list([$Html$Attributes.$class("lead")]),
   _U.list([$Html.text("elm-clipboard is an ")
           ,A2($Html.a,
           _U.list([$Html$Attributes.href("http://elm-lang.org/")]),
           _U.list([$Html.text("Elm")]))
           ,$Html.text(" wrapper for ")
           ,A2($Html.a,
           _U.list([$Html$Attributes.href("http://clipboardjs.com/")]),
           _U.list([$Html.text("Clipboard.js")]))
           ,$Html.text(". See the ")
           ,A2($Html.a,
           _U.list([$Html$Attributes.href("https://github.com/jdudek/elm-clipboard")]),
           _U.list([$Html.text("README")]))
           ,$Html.text(" file for more details.")]));
   var container = function (content) {
      ...
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("three-fourths centered")]),
      content)]))]));
   };
   var TextExample = function (a) {
      return {ctor: "TextExample",_0: a};
   };
   var CutExample = function (a) {
      return {ctor: "CutExample",_0: a};
   };
   var EventExample = function (a) {
      return {ctor: "EventExample",_0: a};
   };
   var TargetExample = function (a) {
      return {ctor: "TargetExample",_0: a};
   };
   var init = function () {
      var mapFx = F2(function (action,_p0) {
         var _p1 = _p0;
         return {ctor: "_Tuple2"
                ,_0: _p1._0
                ,_1: A2($Effects.map,action,_p1._1)};
      });
      var _p2 = {ctor: "_Tuple4"
                ,_0: A2(mapFx,TargetExample,$Example$Target.init)
                ,_1: A2(mapFx,EventExample,$Example$Event.init)
                ,_2: A2(mapFx,CutExample,$Example$Cut.init)
                ,_3: A2(mapFx,TextExample,$Example$Text.init)};
      var m1 = _p2._0._0;
      var fx1 = _p2._0._1;
      var m2 = _p2._1._0;
      var fx2 = _p2._1._1;
      ...
      var m4 = _p2._3._0;
      var fx4 = _p2._3._1;
      var model = {targetExample: m1
                  ,eventExample: m2
                  ,cutExample: m3
                  ,textExample: m4};
      var fx = $Effects.batch(_U.list([fx1,fx2,fx3,fx4]));
      return {ctor: "_Tuple2",_0: model,_1: fx};
   }();
   var update = F2(function (action,model) {
      var _p3 = action;
      switch (_p3.ctor)
      {case "TargetExample": var _p4 = A2($Example$Target.update,
           _p3._0,
           model.targetExample);
           var m = _p4._0;
           var fx = _p4._1;
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,{targetExample: m})
                  ,_1: A2($Effects.map,TargetExample,fx)};
         case "EventExample": var _p5 = A2($Example$Event.update,
           _p3._0,
           model.eventExample);
           var m = _p5._0;
           var fx = _p5._1;
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,{eventExample: m})
                  ,_1: A2($Effects.map,EventExample,fx)};
         case "CutExample": var _p6 = A2($Example$Cut.update,
           _p3._0,
           model.cutExample);
           var m = _p6._0;
           var fx = _p6._1;
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,{cutExample: m})
                  ,_1: A2($Effects.map,CutExample,fx)};
         default: var _p7 = A2($Example$Text.update,
           _p3._0,
           model.textExample);
           var m = _p7._0;
           var fx = _p7._1;
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,{textExample: m})
                  ,_1: A2($Effects.map,TextExample,fx)};}
   });
   var view = F2(function (address,model) {
      var forward = function (fn) {
         return A2($Signal.forwardTo,address,fn);
      };
      return container(_U.list([A2($Html.h1,
                               _U.list([]),
                               _U.list([$Html.text("elm-clipboard")]))
                               ,lead
                               ,A2($Html.section,
                               _U.list([]),
                               _U.list([A2($Html.h2,
                                       _U.list([]),
                                       _U.list([$Html.text("Copy text from attribute")]))
                                       ,A2($Html.p,
                                       _U.list([]),
                                       _U.list([linkToSample("Example/Text.elm")]))
                                       ,A2($Example$Text.view,forward(TextExample),model.textExample)
                                       ,codeSample($Example$Text.code)]))
                               ,A2($Html.section,
                               _U.list([]),
                               _U.list([A2($Html.h2,
                                       _U.list([]),
                                       _U.list([$Html.text("Event triggered after successful copying")]))
                                       ,A2($Html.p,
                                       _U.list([]),
                                       _U.list([linkToSample("Example/Event.elm")]))
                                       ,A2($Example$Event.view,
                                       forward(EventExample),
                                       model.eventExample)
                                       ,codeSample($Example$Event.code)]))
                               ,A2($Html.section,
                               _U.list([]),
                               _U.list([A2($Html.h2,
                                       _U.list([]),
                                       _U.list([$Html.text("Copy text from another element")]))
                                       ,A2($Html.p,
                                       _U.list([]),
                                       _U.list([linkToSample("Example/Target.elm")]))
                                       ,A2($Example$Target.view,
                                       forward(TargetExample),
                                       model.targetExample)
                                       ,codeSample($Example$Target.code)]))
                               ,A2($Html.section,
                               _U.list([]),
                               _U.list([A2($Html.h2,
                                       _U.list([]),
                                       _U.list([$Html.text("Cut text from another element")]))
                                       ,A2($Html.p,
                                       _U.list([]),
                                       _U.list([linkToSample("Example/Cut.elm")]))
                                       ,A2($Example$Cut.view,forward(CutExample),model.cutExample)
                                       ,codeSample($Example$Cut.code)]))]));
   });
   ...
   var Model = F4(function (a,b,c,d) {
      return {targetExample: a
             ,eventExample: b
             ,cutExample: c
             ,textExample: d};
   });
   return _elm.Example.values = {_op: _op
                                ,Model: Model
